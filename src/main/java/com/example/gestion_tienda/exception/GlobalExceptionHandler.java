...
@RestControllerAdvice //Captura errores globales
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleValidationErrors(MethodArgumentNotValidException ex){
        ...
        //Se recorren los posibles errores, @NotNull, @NotBlank, @Size...
    ...
    //Para errores propios de la clase O fallas internas O el tipico 500
    ...
    //Usado para cuando sucede una regla de negocio
    ...
    //Util cuando deseamos que se sepa que el DTO o json esta incompleto.
